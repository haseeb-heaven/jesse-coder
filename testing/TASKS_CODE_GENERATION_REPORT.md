...
| `task_02` | LRU Cache | `python` | ✅ PASS | 56.5ms | Matches expected output |
| `task_03` | Sliding Window Rate Limiter | `python` | ❌ FAIL | 30.7ms | Output mismatch. |
| `task_04` | Shortest Path | `python` | ✅ PASS | 66.3ms | Equivalent output (labels/format ignored) |
| `task_05` | Inventory Transaction | `python` | ❌ FAIL | 60.6ms | Output mismatch. |
| `task_06` | Payment Aggregation | `python` | ❌ FAIL | 58.8ms | Output mismatch. |
| `task_07` | Merge Time Intervals | `python` | ❌ FAIL | 47.9ms | Output mismatch. |
| `task_08` | Binary Search Tree | `python` | ❌ FAIL | 65.2ms | Output mismatch. |
| `task_09` | Dependency Build Order | `python` | ❌ FAIL | 60.5ms | Output mismatch. |
| `task_10` | Video Watch Time | `python` | ❌ FAIL | 61.3ms | Output mismatch. |
| `task_11` | Weighted Job Scheduling | `python` | ❌ FAIL | 0.0ms | No valid code block extracted from model response. |
| `task_12` | Dynamic Connectivity | `python` | ❌ FAIL | 67.3ms | Output mismatch. |
...
| `task_15` | Weighted Grid Shortest Path | `python` | ❌ FAIL | 65.2ms | Output mismatch. |
...
| `task_19` | LFU Cache | `python` | ✅ PASS | 44.4ms | Matches expected output |
| `task_20` | DAG Critical Path | `python` | ❌ FAIL | 49.8ms | Output mismatch. |
